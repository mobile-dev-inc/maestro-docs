...
While **Maestro Studio** is often used to _create_ tests visually, it's the **Maestro command-line tool** that typically orchestrates automatic execution within CI systems (such as GitHub Actions, Jenkins, CircleCI).
