...
Here’s another example that logs `"Hello World"` four times. The `output.counter < 10` condition acts as an escape hatch, ensuring the loop exits safely if the JavaScript counter logic behaves unexpectedly.
