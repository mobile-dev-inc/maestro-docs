...
| Option                     | Description                                                                                                     |
| -------------------------- | --------------------------------------------------------------------------------------------------------------- |
| `--device-locale=<locale>` | Combination of lowercase ISO-639-1 code and uppercase ISO-3166-1 code (for example, "de\_DE" for Germany).      |
| `--device-locale=<locale>` | Use a combination of lowercase ISO-639-1 code and uppercase ISO-3166-1 code, for example: "de\_DE" for Germany. |
