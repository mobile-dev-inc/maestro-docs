...
Maestro synthesizes tap events and leverages the accessibility hierarchy (UIAccessibility/AccessibilityNodeProvider) for element detection, making framework choice irrelevant to test execution.
