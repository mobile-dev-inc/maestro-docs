...
If you've not already got an emulator running, start one now. You can do that with the Android SDK tools, through Android Studio, or via Maestro's [Start Device](../../cli/start-device.md) command.
